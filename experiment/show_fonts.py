...
if subject_ID:
    ...
    if response_map == 'yes_left':
        key_to_answer = {'left': 'yes', 'right': 'no'}
        yes_pos, no_pos = (-50, -50), (50, -50)
    else:  # 'yes_right'
        key_to_answer = {'left': 'no', 'right': 'yes'}
        yes_pos, no_pos = (50, -50), (-50, -50)
    ...
    \nWhile we wait, please read the instructions:\
    ...
    \nMovement of even 1-2 mm can be deterimental to the data quality.\
